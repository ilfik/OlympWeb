...
namespace OlympWeb.Controllers
{
    public class AnswersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_answer,question_id,answer_text,is_correct")] Answers answers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_answer,question_id,answer_text,is_correct")] Answers answers)
        {
            if (ModelState.IsValid)
            {
